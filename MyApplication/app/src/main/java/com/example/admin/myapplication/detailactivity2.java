...
public class detailactivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        About = (ImageButton)findViewById(R.id.imageButton1);
        About.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(detailactivity2.this, About2.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(detailactivity2.this, MainActivity2.class);
                try {
                    if(mMedia.isPlaying()){
                        mMedia.stop();
                        mMedia.release();
        ...
        soundth.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    mMedia = MediaPlayer.create(detailactivity2.this,soundfileTH[id]);
                    mMedia.start();
                } catch(Exception ex) {
                    mMedia = MediaPlayer.create(detailactivity2.this,soundfileTH[id]);
                    mMedia.start();
        ...
        sounden.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    mMedia = MediaPlayer.create(detailactivity2.this,soundfileEN[id]);
                    mMedia.start();
                } catch(Exception ex) {
                    mMedia = MediaPlayer.create(detailactivity2.this,soundfileEN[id]);
                    mMedia.start();
